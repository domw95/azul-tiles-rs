//! The players that are not the minimax search.
//!
//! Split out so that `players::minimax` can be built without nalgebra,
//! rand_distr or dyn-clone, none of which a wasm build of the search needs.
